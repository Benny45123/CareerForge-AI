...
import coverLetterPageDesign from '../assets/coverLetterPageDesign.png';
...
const handleChange=(e)=>{
    ...
    return (
    <>
    <div style={{backgroundImage: `url(${coverLetterPageDesign})`,backgroundSize: 'cover',backgroundPosition: 'center',}} className="min-h-screen flex justify-center items-center p-4 " >
<form onSubmit={handleClick} className={`transition-all duration-500 ${isOpen ? "md:w-3/4 ml-[25%]" : "md:w-full ml-0"} h-full bg-white/5  border border-gray-300  shadow-2xl  rounded-3xl  p-10`}>
    <div>
    <div className=' p-6 rounded-2xl shadow-md'>
     ...
     <br/></div>
      <div className=' p-4 rounded-2xl shadow-md mb-10'>
